class TitolariController < ApplicationController
  ...
  private
    ...
    def titolare_params
      params.require(:titolare).permit(:nome,:cognome,:cf,:data_nascita,:telefono,:email,:piva,:actable_id,:actable_type,:password,:password_confirmation,:indirizzo_titolare,:citta_id)
    end
end
