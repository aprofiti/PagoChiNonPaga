...
RSpec.describe Titolare, type: :model do
  it "is invalid without a nome" do
    ...
    piva: "abcde", data_nascita: Date.parse('04/11/1991'), cf: 'adbajdb', indirizzo: 'via via', citta_id: 1, locality: "", email_paypal: "fakeaccount@account.com", confirmed_at: Date.parse('01/01/2017'))
  ...
  it "is invalid without a piva" do
    ...
    piva: "", data_nascita: Date.parse('04/11/1991'), cf: 'adbajdb', indirizzo: 'via via', citta_id: 1, locality: "", email_paypal: "fakeaccount@account.com", confirmed_at: Date.parse('01/01/2017'))

    expect(titolare).not_to be_valid
  end
  it "is invalid without a data_nascita" do
    titolare= Titolare.new(nome: 'Nome', cognome: 'Cognome', email: 'boh@boh.it', password: '123456', password_confirmation: '123456', telefono: '46498',
    piva: "abcde", cf: 'adbajdb', indirizzo: 'via via', citta_id: 1, locality: "", email_paypal: "fakeaccount@account.com", confirmed_at: Date.parse('01/01/2017'))

    expect(titolare).not_to be_valid
  end
  it "is invalid without a cf" do
    titolare= Titolare.new(nome: 'Nome', cognome: 'Cognome', email: 'boh@boh.it', password: '123456', password_confirmation: '123456', telefono: '46498',
    piva: "abcde", data_nascita: Date.parse('04/11/1991'), cf: '', indirizzo: 'via via', citta_id: 1, locality: "", email_paypal: "fakeaccount@account.com", confirmed_at: Date.parse('01/01/2017'))

    expect(titolare).not_to be_valid
  end
  it "is invalid without a indirizzo" do
    titolare= Titolare.new(nome: 'Nome', cognome: 'Cognome', email: 'boh@boh.it', password: '123456', password_confirmation: '123456', telefono: '46498',
    piva: "abcde", data_nascita: Date.parse('04/11/1991'), cf: 'idjaid', indirizzo: '', citta_id: 1, locality: "", email_paypal: "fakeaccount@account.com", confirmed_at: Date.parse('01/01/2017'))

    expect(titolare).not_to be_valid
  end
  it "is invalid with a nome with special chars" do
    titolare= Titolare.new(nome: 'Nome?', cognome: 'Cognome', email: 'boh@boh.it', password: '123456', password_confirmation: '123456', telefono: '46498',
    piva: "abcde", data_nascita: Date.parse('04/11/1991'), cf: 'dkak', indirizzo: 'via via', citta_id: 1, locality: "", email_paypal: "fakeaccount@account.com", confirmed_at: Date.parse('01/01/2017'))
