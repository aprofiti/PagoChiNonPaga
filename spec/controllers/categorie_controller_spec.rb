...
RSpec.describe CategorieController, type: :controller do
  ...
  # CategorieController. Be sure to keep this updated too.
  let(:valid_session) { {} }
  ...
  describe "GET #index" do
    it "assigns all categories as @categories" do
      ...
      expect(assigns(:categorie)).to eq([categoria])
    end
  end
  ...
  describe "GET #show" do
    it "assigns the requested categoria as @categoria" do
      categoria = Categoria.create! valid_attributes
      get :show, params: {id: categoria.to_param}, session: valid_session
  ...
  describe "GET #edit" do
    it "assigns the requested categoria as @categoria" do
      categoria = Categoria.create! valid_attributes
      get :edit, params: {id: categoria.to_param}, session: valid_session
      expect(assigns(:categoria)).to eq(categoria)
    end
  end
  ...
  describe "POST #create" do
    context "with valid params" do
      it "creates a new Categoria" do
        expect {
          post :create, params: {categoria: valid_attributes}, session: valid_session
    ...
    context "with invalid params" do
      it "assigns a newly created but unsaved categoria as @categoria" do
        post :create, params: {categoria: invalid_attributes}, session: valid_session
        expect(assigns(:categoria)).to be_a_new(Categoria)
      end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested categoria" do
        categoria = Categoria.create! valid_attributes
        put :update, params: {id: categoria.to_param, categoria: new_attributes}, session: valid_session
        categoria.reload
      ...
      it "assigns the requested categoria as @categoria" do
        categoria = Categoria.create! valid_attributes
        put :update, params: {id: categoria.to_param, categoria: valid_attributes}, session: valid_session
        expect(assigns(:categoria)).to eq(categoria)
      end
    ...
    context "with invalid params" do
      it "assigns the categoria as @categoria" do
        categoria = Categoria.create! valid_attributes
        put :update, params: {id: categoria.to_param, categoria: invalid_attributes}, session: valid_session
        expect(assigns(:categoria)).to eq(categoria)
      end
  ...
  describe "DELETE #destroy" do
    it "destroys the requested categoria" do
      categoria = Categoria.create! valid_attributes
      expect {
        delete :destroy, params: {id: categoria.to_param}, session: valid_session
      }.to change(Categoria, :count).by(-1)
    end

    it "redirects to the categorie list" do
      categoria = Categoria.create! valid_attributes
      delete :destroy, params: {id: categoria.to_param}, session: valid_session
      expect(response).to redirect_to(categorie_url)
    end
  end
