...
Cliente.create(nome: 'Franco', cognome: 'Massimo', cf: 'jasdnjd', telefono: '15325', data_nascita: Date.parse('01/01/1992'), email: 'cli3@ente.it', password: '123456', password_confirmation: '123456', indirizzo: 'via di cristo', citta_id: 1)
Cliente.create(nome: 'Tommaso', cognome: 'Meraviglia', cf: 'skanjd', telefono: '1242', data_nascita: Date.parse('03/05/1907'), email: 'cli4@ente.it', password: '123456', password_confirmation: '123456', indirizzo: 'via del cannolo', citta_id: 2)
Cliente.create(nome: 'Massimo', cognome: 'Franco', cf: 'sdakcc', telefono: '15252', data_nascita: Date.parse('01/05/1930'), email: 'cli5@ente.it', password: '123456', password_confirmation: '123456', indirizzo: 'via dallo scroto', citta_id: 2)
Cliente.create(nome: 'Ambrogio', cognome: 'De Scrotiis', cf: 'nsjns', telefono: '98989', data_nascita: Date.parse('11/11/1952'), email: 'cli6@ente.it', password: '123456', password_confirmation: '123456', indirizzo: 'via dallo scroto', citta_id: 3)
Cliente.create(nome: 'Fra', cognome: 'Nebbia', cf: 'wdjiwj9', telefono: '5737378', data_nascita: Date.parse('01/08/2000'), email: 'cli7@ente.it', password: '123456', password_confirmation: '123456', indirizzo: 'via fazio', citta_id: 3)
Cliente.create(nome: 'Riccardo', cognome: 'Ilgrande', cf: 'w9udw9jf', telefono: '3838', data_nascita: Date.parse('02/09/1996'), email: 'cli8@ente.it', password: '123456', password_confirmation: '123456', indirizzo: 'via cavour', citta_id: 3)
Cliente.create(nome: 'Mafioso', cognome: 'Per Eccellenza', cf: 'wd9wjw', telefono: '463746', data_nascita: Date.parse('08/02/1991'), email: 'cli9@ente.it', password: '123456', password_confirmation: '123456', indirizzo: 'via telecomando', citta_id: 4)
Cliente.create(nome: 'Al', cognome: 'Alino', cf: 'f3jfi2', telefono: '249209', data_nascita: Date.parse('01/05/1997'), email: 'cli10@ente.it', password: '123456', password_confirmation: '123456', indirizzo: 'via assurda', citta_id: 5)
Cliente.create(nome: 'John', cognome: 'Tortora', cf: '2iin2f', telefono: '22746', data_nascita: Date.parse('01/05/1969'), email: 'cli11@ente.it', password: '123456', password_confirmation: '123456', indirizzo: 'via dello scandalo', citta_id: 6)
Cliente.create(nome: 'Jack', cognome: 'Baglio', cf: 'j9wj9j29', telefono: '0292836', data_nascita: Date.parse('31/12/1999'), email: 'cli12@ente.it', password: '123456', password_confirmation: '123456', indirizzo: 'Contrada massiccia', citta_id: 7)
Cliente.create(nome: 'Soreta', cognome: 'Mammeta', cf: '1uhue', telefono: '3467365', data_nascita: Date.parse('04/06/1977'), email: 'cli13@ente.it', password: '123456', password_confirmation: '123456', indirizzo: 'Largo Sorella', citta_id: 8)
Cliente.create(nome: 'Mortacci', cognome: 'Tua', cf: '2uh2uh', telefono: '38573857', data_nascita: Date.parse('01/05/1990'), email: 'cli14@ente.it', password: '123456', password_confirmation: '123456', indirizzo: 'Rotonda di zio peppe', citta_id: 9)
Cliente.create(nome: 'Francesco', cognome: 'Totti', cf: '29j02j0', telefono: '263748', data_nascita: Date.parse('02/05/1980'), email: 'cli15@ente.it', password: '123456', password_confirmation: '123456', indirizzo: 'La strada del buon pastore', citta_id: 10)
Cliente.create(nome: 'Bello Figo', cognome: 'Gu', cf: 'uh21ueh', telefono: '746758', data_nascita: Date.parse('01/03/2004'), email: 'cli16@ente.it', password: '123456', password_confirmation: '123456', indirizzo: 'Via agnello', citta_id: 10)

Titolare.create(nome: 'Tito', cognome: 'Lare', email: 'tito1@lare.it', password: '123456', password_confirmation: '123456', telefono: '3423556', data_nascita: Date.parse('01/05/1930'), cf: 'sdgsg', indirizzo: 'via della vita', citta_id: 8)
Titolare.create(nome: 'Giangiovanni', cognome: 'Itto', email: 'tito2@lare.it', password: '123456', password_confirmation: '123456', telefono: '73249', data_nascita: Date.parse('09/06/1955'), cf: 'kfmkimke', indirizzo: 'via in culo', citta_id: 1)
Titolare.create(nome: 'Mimmo', cognome: 'Trippa', email: 'tito3@lare.it', password: '123456', password_confirmation: '123456', telefono: '000222', data_nascita: Date.parse('03/05/1907'), cf: 'einjnf', indirizzo: 'via stanchezza', citta_id: 10)
Titolare.create(nome: 'Edoardo', cognome: 'Dei Boschi', email: 'tito4@lare.it', password: '123456', password_confirmation: '123456', telefono: '634622', data_nascita: Date.parse('04/11/1991'), cf: 'ijgin', indirizzo: 'via del sospiro', citta_id: 2)
Titolare.create(nome: 'Dio', cognome: 'Bello', email: 'tito5@lare.it', password: '123456', password_confirmation: '123456', telefono: '987765654', data_nascita: Date.parse('08/08/1964'), cf: 'wefjun', indirizzo: 'via alla menta', citta_id: 3)
