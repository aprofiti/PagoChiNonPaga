...
Ordine.create(cliente_id: 4, impresa_id: 3, stato_ordine_id: 1, spedizione: 0.0, totale: 0.0).save(validate: false)
Ordine.create(cliente_id: 2, impresa_id: 7, stato_ordine_id: 1, spedizione: 0.0, totale: 0.0).save(validate: false)
Ordine.create(cliente_id: 5, impresa_id: 4, stato_ordine_id: 2, spedizione: 0.0, totale: 0.0).save(validate: false)
Ordine.create(cliente_id: 5, impresa_id: 5, stato_ordine_id: 2, spedizione: 0.0, totale: 0.0).save(validate: false)
Ordine.create(cliente_id: 3, impresa_id: 4, stato_ordine_id: 2, spedizione: 0.0, totale: 0.0).save(validate: false)
Ordine.create(cliente_id: 4, impresa_id: 4, stato_ordine_id: 3, spedizione: 0.0, totale: 0.0).save(validate: false)
Ordine.create(cliente_id: 5, impresa_id: 6, stato_ordine_id: 4, spedizione: 0.0, totale: 0.0).save(validate: false)
# Ordine verso impresa Congelata
Ordine.create(cliente_id: 1, impresa_id: 12, stato_ordine_id: 1, spedizione: 0.0, totale: 0.0).save(validate: false)
