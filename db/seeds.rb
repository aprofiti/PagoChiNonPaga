...
Cliente.create(nome: 'Gigi', cognome: 'Meraviglia', cf: 'ajsjsan', telefono: '12345', data_nascita: Date.parse('08/08/1964'), email: 'cli1@ente.it', password: '123456', password_confirmation: '123456', indirizzo: 'Via Italia', citta_id: 1, confirmed_at: Date.parse('01/01/2017'))
Cliente.create(nome: 'Rino', cognome: 'Rino', cf: 'dsahju', telefono: '1354', data_nascita: Date.parse('04/11/1991'), email: 'cli2@ente.it', password: '123456', password_confirmation: '123456', indirizzo: 'Via del Corso', citta_id: 1, confirmed_at: Date.parse('01/01/2017'))
Cliente.create(nome: 'Franco', cognome: 'Massimo', cf: 'jasdnjd', telefono: '15325', data_nascita: Date.parse('01/01/1992'), email: 'cli3@ente.it', password: '123456', password_confirmation: '123456', indirizzo: 'Piazza della liberazione', citta_id: 1, confirmed_at: Date.parse('01/01/2017'))
Cliente.create(nome: 'Tommaso', cognome: 'Meraviglia', cf: 'skanjd', telefono: '1242', data_nascita: Date.parse('03/05/1907'), email: 'cli4@ente.it', password: '123456', password_confirmation: '123456', indirizzo: 'Via Catania', citta_id: 2, confirmed_at: Date.parse('01/01/2017'))
Cliente.create(nome: 'Massimo', cognome: 'Franco', cf: 'sdakcc', telefono: '15252', data_nascita: Date.parse('01/05/1930'), email: 'cli5@ente.it', password: '123456', password_confirmation: '123456', indirizzo: 'Via Palermo', citta_id: 2, confirmed_at: Date.parse('01/01/2017'))
Cliente.create(nome: 'Ambrogio', cognome: 'De Scrotiis', cf: 'nsjns', telefono: '98989', data_nascita: Date.parse('11/11/1952'), email: 'cli6@ente.it', password: '123456', password_confirmation: '123456', indirizzo: 'Via Roma', citta_id: 3, confirmed_at: Date.parse('01/01/2017'))
Cliente.create(nome: 'Fra', cognome: 'Nebbia', cf: 'wdjiwj9', telefono: '5737378', data_nascita: Date.parse('01/08/2000'), email: 'cli7@ente.it', password: '123456', password_confirmation: '123456', indirizzo: 'Via della Libertà', citta_id: 3, confirmed_at: Date.parse('01/01/2017'))
...
Cliente.create(nome: 'Linus', cognome: 'Torvalds', cf: 'wd9wjw', telefono: '463746', data_nascita: Date.parse('08/02/1991'), email: 'cli9@ente.it', password: '123456', password_confirmation: '123456', indirizzo: 'Via da qui', citta_id: 4, confirmed_at: Date.parse('01/01/2017'))
...
Cliente.create(nome: 'Mario', cognome: 'Rossi', cf: '2uh2uh', telefono: '38573857', data_nascita: Date.parse('01/05/1990'), email: 'cli14@ente.it', password: '123456', password_confirmation: '123456', indirizzo: 'Rotonda di zio peppe', citta_id: 9, confirmed_at: Date.parse('01/01/2017'))
Cliente.create(nome: 'Arturo', cognome: 'Di Napoli', cf: '29j02j0', telefono: '263748', data_nascita: Date.parse('02/05/1980'), email: 'cli15@ente.it', password: '123456', password_confirmation: '123456', indirizzo: 'La strada del buon pastore', citta_id: 10, confirmed_at: Date.parse('01/01/2017'))
...
piva: "abcde", data_nascita: Date.parse('09/06/1955'), cf: 'kfmkimke', indirizzo: 'via in numeri', citta_id: 1,email_paypal: "fakeaccount@account.com", confirmed_at: Date.parse('01/01/2017'))
...
Titolare.create(nome: 'Sergio', cognome: 'Leone', email: 'tito5@lare.it', password: '123456', password_confirmation: '123456', telefono: '987765654',
