...
Impresa.create(nome: 'We uaglio bell stu orologgg', telefono: '36636', descrizione: 'Orolog belli', titolare_id: 4, citta_id: 3, verificato: true, congelato: true,indirizzo: 'Via Catania 30', email: 'impre12@sa.it').save(validate: false)
...
Prodotto.create(nome:'Orologi', prezzo: 100, descrizione: 'Orologi Napoletani', qta: 50, impresa_id: 12, eliminato: false)
